...
> **Registro desta etapa.** Isto é planejamento, insight e tendência: demanda, jornada, volume
> e termos. Métricas de eficiência de compra — KD, CPC, densidade competitiva — são **insumo
> tático** e estão parqueadas no anexo, para o cluster de mídia. Elas não sustentam argumento
> de território aqui.
...
**Enxerga:** demanda expressa e seu tamanho, a composição dela por tipo de necessidade, os
termos exatos com que ela é formulada, e a forma temporal ao longo de 12 meses.
...
| Player | kw | Volume/mês | AI Overview no SERP | Intenção dominante |
|---|---:|---:|---:|---|
| Categoria (heads sem marca) | 65 | 6.869.800 | 28% | Comercial 62% |
| Brastemp | 1.998 | 2.949.270 | 22% | Informacional 66% |
| Consul | 1.064 | 1.483.110 | 27% | Informacional 53% |
| **Electrolux** | 900 | 711.670 | **14%** | Informacional 40%, Comercial 34% |
| Midea | 101 | 552.800 | 25% | Informacional 50%, Navegacional 40% |
| **Território sem dono** | 492 | 207.600 | **58%** | Informacional 74% |
| Hisense | 493 | 172.660 | 49% | Informacional 52% |
| Samsung | 300 | 125.460 | 18% | Informacional 78% |
| Haier | 44 | 4.480 | 59% | Informacional 57% |
...
## 5. O nono player: o território sem dono
...
**Nenhum player o reivindica.** É demanda de categoria que não está atrelada a marca nenhuma —
espaço mental sem dono. **Intenção informacional em 74% do volume**, contra 62% comercial nas
cabeças: é território de conteúdo e de relação, não de decisão de compra. E **58% das consultas
exibem AI Overview no SERP**, a maior taxa do dataset junto com a Haier.
...
## 6. Leitura por player

**Electrolux** — jornada de escolha de produto, demanda estável sem ganho de share. A fatia de
posse (4,4%) é metade da Consul, apesar de posicionamento superior. As famílias de pós-compra crescem, as frentes
nomeadas encolhem.

**Brastemp** — a maior base de demanda do conjunto. **Perde share a 0,86.** Jornada de escolha,
com posse baixa (3,5%) para o tamanho da base.

**Consul** — a jornada mais madura da categoria: 8,1% em posse, o dobro da Electrolux. Estável
em share. É o player que melhor converteu base instalada em relação buscável.

**Samsung** — leitura limitada pelo seed. **Perde share a 0,85**, a maior queda do conjunto.
Intenção 78% informacional.
...
com termos de validação de reputação no topo (`hisense é boa`). Ressalva: o share relativo mostra pico nos meses 8-9 e recuo depois — parte do
...
nome da marca: estágio inicial de formação.

---

## 7. Limites desta trilha
...
## Anexo tático — dificuldade e custo (insumo para o cluster de mídia)

> Parqueado aqui de propósito. Estes números respondem *como comprar*, não *o que ocupar*.
> Servem ao entregável de Brand Media e Performance Media, não à leitura de território.
